<template lang="">
   <div id="home" class="uk-margin-medium-top">
      <img src="imagens/easyservice.png" class="uk-align-center" width="450"  alt="" />
      <div class=" uk-grid-collapse uk-child-width-expand@s uk-text-center uk-margin-top uk-margin-large-bottom" uk-grid>
